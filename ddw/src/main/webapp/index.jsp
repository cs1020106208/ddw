  ...
  <div id="center">
    ...
    <div id="center_middle">
      ...
      <div class="chknumber">
        ...
        </label><img width="50" height="30" src="${pageContext.request.contextPath}/getKaptcha" id="imgVcode" onclick="document.getElementById('imgVcode').src='${pageContext.request.contextPath}/validateCode/code.do?time='+(new Date()).getTime();"  />
      </div>
    </div>
